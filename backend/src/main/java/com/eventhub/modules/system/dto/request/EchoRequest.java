 ...
 * 当前请求模型保持轻量，主要用于演示“客户端提交请求 -> Spring 绑定参数 -> Bean Validation 校验 ->
 * 进入服务层处理”的基础闭环。
 *
 * <p>
 ...
 *
 * <p>
 * {@link Schema} 是 Springdoc OpenAPI / Swagger 提供的模型字段说明注解，
 ...
 *
 * <p>
 * 需要注意的是，{@link Schema} 和 {@link NotBlank}/{@link Size} 分工不同：
 * 前者负责文档描述，后者负责运行时校验。
